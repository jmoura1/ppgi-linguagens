...
\end{itemize}
 \begin{block}{}
      \begin{align*}
        %  & \mbox{\infer{\texttt{\frenchspacing S <: T}}{\texttt{\frenchspacing S <: U}} & &  \texttt{\frenchspacing U <: T}} & & \textsc{(S-Trans)}
         & \mbox{\footnotesize \infer{\texttt{\frenchspacing $\{ k_j : S_j\ ^{j \in 1..n} \} <: \{ _i : T_i\ ^{i \in 1..n} \} $}}{\texttt{\frenchspacing $\{ k_j : S_j\ ^{j \in 1..n} \}$ is a permutation of $ \{ \rceil_i : T_i\ ^{i \in 1..n} \} $}}} & & \textsc{(S-RcdPerm)}
      \end{align*}
   \end{block}
\end{frame}
